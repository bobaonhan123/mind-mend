...
const News = (props) => {
  const imageList = [
    { img: './PublicAssets/Img/NewsPage/1.jpg', heading: '"Hạnh phúc là trạng thái tâm lý, không phải mục tiêu cuối cùng." - Martin Seligman' },
    { img: './PublicAssets/Img/NewsPage/2.jpg', heading: '"Sự thay đổi bắt đầu khi bạn quyết định không chấp nhận tình trạng hiện tại."' },
    { img: './PublicAssets/Img/NewsPage/3.jpg', heading: '"Hãy hiểu tâm lý của bạn, bạn sẽ hiểu được mọi thứ."' },
    { img: './PublicAssets/Img/NewsPage/1.jpg', heading: '"Sức mạnh của tâm lý xác định sự khác biệt."' }
  ];
  return (
    <div className="News">
